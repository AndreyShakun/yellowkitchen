(() => {
    ...
    function initSliders() {
        if (document.querySelector(".restaurants__slider")) new core(".restaurants__slider", {
            ...
            navigation: {
                prevEl: ".restaurants__swiper-button-prev",
                nextEl: ".restaurants__swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".specialities__slider")) new core(".specialities__slider", {
            modules: [ Navigation, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 8,
            ...
            navigation: {
                prevEl: ".specialities__swiper-button-prev",
                nextEl: ".specialities__swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 2,
